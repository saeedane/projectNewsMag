...
$demo['plugin'] = array( 'js_composer', 'newsy-elements', 'newsy-social-share', 'newsy-voting', 'newsy-reaction', 'newsy-social-counter', 'newsy-view-counter', 'newsy-membership' );
...
$demo['media'] = array(
	...
	array(
		...
		'file'   => $demo_import_url . 'cat_logos/animal-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-anime-logo',
		'file'   => $demo_import_url . 'cat_logos/anime-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-awesome-logo',
		'file'   => $demo_import_url . 'cat_logos/awesome-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-auto-logo',
		'file'   => $demo_import_url . 'cat_logos/auto-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-comic-logo',
		'file'   => $demo_import_url . 'cat_logos/comic-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-country-logo',
		'file'   => $demo_import_url . 'cat_logos/country-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-crafts-logo',
		'file'   => $demo_import_url . 'cat_logos/crafts-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-food-logo',
		'file'   => $demo_import_url . 'cat_logos/food-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-funny-logo',
		'file'   => $demo_import_url . 'cat_logos/funny-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-gaming-logo',
		'file'   => $demo_import_url . 'cat_logos/gaming-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-nsfw-logo',
		'file'   => $demo_import_url . 'cat_logos/nsfw-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-gif-logo',
		'file'   => $demo_import_url . 'cat_logos/gif-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-girl-logo',
		'file'   => $demo_import_url . 'cat_logos/girl-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-horror-logo',
		'file'   => $demo_import_url . 'cat_logos/horror-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-music-logo',
		'file'   => $demo_import_url . 'cat_logos/music-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-movie-logo',
		'file'   => $demo_import_url . 'cat_logos/movie-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-memes-logo',
		'file'   => $demo_import_url . 'cat_logos/memes-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-politics-logo',
		'file'   => $demo_import_url . 'cat_logos/politics-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-savage-logo',
		'file'   => $demo_import_url . 'cat_logos/savage-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-satisfying-logo',
		'file'   => $demo_import_url . 'cat_logos/satisfying-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-school-logo',
		'file'   => $demo_import_url . 'cat_logos/school-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-sport-logo',
		'file'   => $demo_import_url . 'cat_logos/sport-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-video-logo',
		'file'   => $demo_import_url . 'cat_logos/video-logo.jpg',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-tech-logo',
		'file'   => $demo_import_url . 'cat_logos/tech-logo.png',
		'resize' => false,
	),
	array(
		'the_ID' => 'ak-wtf-logo',
		'file'   => $demo_import_url . 'cat_logos/wtf-logo.jpg',
		'resize' => false,
	),
	// reactions
	array(
...
$demo['taxonomy'] = array(
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-animal-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-anime-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-awesome-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
	...
	array(
		...
		'taxonomy_meta' => array(
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-auto-logo%attachment_url%',
			),
			array(
				'key'   => 'term_header_style',
				'value' => 'style-5',
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-auto-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-comic-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-country-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-crafts-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-food-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-funny-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-gaming-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-gif-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-girl-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-horror-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
	...
	array(
		'the_ID'        => 'ak-memes',
		'name'          => 'Memes',
		'description'   => 'he Biggest Video Meme Platform',
		'taxonomy'      => 'category',
		'taxonomy_meta' => array(
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-memes-logo%attachment_url%',
			),
			array(
				'key'   => 'term_header_style',
				'value' => 'style-5',
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-memes-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
	...
	array(
		'the_ID'        => 'ak-music',
		'name'          => 'Music',
		'description'   => 'Music styles, types and genres',
		'taxonomy'      => 'category',
		'taxonomy_meta' => array(
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-music-logo%attachment_url%',
			),
			array(
				'key'   => 'term_header_style',
				'value' => 'style-5',
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-music-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-movie-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-nsfw-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-politics-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-satisfying-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-savage-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-school-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-sport-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-tech-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-video-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => array(
					'background' => array(
						'image' => array(
							'img'  => '%attachment_url%ak-wtf-logo%attachment_url%',
							'type' => 'parallax',
						),
					),
				),
...
$demo['post'] = array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-anime%%,%%ak-tech%%,%%ak-gif%%',
		),
		'post_meta'         => array(
			array(
	...
	array(
		'the_ID'            => 'ak-post-3',
		'post_title'        => '20 Facts That Will Absolutely Demolish Everything You Thought You Knew',
		'post_excerpt_file' => $demo_path . 'pages/post-excerpt-1.txt',
		'post_content_file' => $demo_path . 'pages/post-content-1.txt',
		...
		'post_meta'         => array(
			array(
				...
				'value' => array(
					'type' => 'url',
					'url'  => 'https://www.youtube.com/watch?v=pw71fASdluk',
					'time' => '25:16',
				),
			),
		),
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-animals%%,%%ak-crafts%%,%%ak-gaming%%,%%ak-gif%%',
		),
		'post_meta'         => array(
			array(
				'key'   => 'post_primary_category',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-animals%%,%%ak-gaming%%',
		),
		'post_format'       => 'post',
	),
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-funny%%,%%ak-anime%%,%%ak-crafts%%',
		),
		'post_format'       => 'post',
		'post_meta'         => array(
			array(
				...
				'value' => array(
					'type' => 'url',
					'url'  => 'https://twitter.com/Twitter/status/1564598913784549376',
				),
			),
		),
	),
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-funny%%,%%ak-satisfying%%,%%ak-savage%%,%%ak-crafts%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-comic%%,%%ak-food%%,%%ak-animals%%,%%ak-anime%%',
		),
		'post_format'       => 'post',
	),
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-funny%%,%%ak-savage%%,%%ak-country%%,%%ak-crafts%%',
		),
		'post_format'       => 'post',
	),
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-politics%%,%%ak-animals%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-funny%%,%%ak-comic%%,%%ak-gaming%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-funny%%,%%ak-satisfying%%,%%ak-country%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-animals%%,%%ak-funny%%,%%ak-country%%',
		),
		'post_format'       => 'post',
	),
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-satisfying%%,%%ak-politics%%,%%ak-gaming%%',
		),
		'post_format'       => 'post',
	),
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-funny%%,%%ak-food%%,%%ak-anime%%,%%ak-country%%',
		),
		'post_format'       => 'post',
		'post_meta'         => array(
			array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-auto%%,%%ak-animals%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-satisfying%%,%%ak-gaming%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-food%%,%%ak-auto%%,%%ak-comic%%,%%ak-politics%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-satisfying%%,%%ak-auto%%,%%ak-comic%%',
		),
		'post_format'       => 'post',
	),
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-awesome%%,%%ak-funny%%,%%ak-animals%%,%%ak-politics%%',
		),
		'post_format'       => 'post',
	),
	array(
